...
You would call it 500 times, because 100 * 10 = 1000.  You create half that many, because all friendships are bi-directional, so if call add_friendships() 500 times, you're creating 1000 friendships.
